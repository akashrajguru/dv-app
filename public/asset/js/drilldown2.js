...
{ id: 'temperature02',
  name: 'Temperature deg.C',
  data: 
   [ { name: '1:00 AM', y: 3.7, drilldown: 'temp1:00 AM' },
     { name: '2:00 AM', y: 3.3, drilldown: 'temp2:00 AM' },
     { name: '3:00 AM', y: 2.9, drilldown: 'temp3:00 AM' },
     { name: '4:00 AM', y: 2.5, drilldown: 'temp4:00 AM' },
     { name: '5:00 AM', y: 2.4, drilldown: 'temp5:00 AM' },
     { name: '6:00 AM', y: 2.3, drilldown: 'temp6:00 AM' },
     { name: '7:00 AM', y: 2.2, drilldown: 'temp7:00 AM' },
     { name: '8:00 AM', y: 4.3, drilldown: 'temp8:00 AM' },
     { name: '9:00 AM', y: 6.4, drilldown: 'temp9:00 AM' },
     { name: '10:00 AM', y: 8.5, drilldown: 'temp10:00 AM' },
     { name: '11:00 AM', y: 10, drilldown: 'temp11:00 AM' },
     { name: '12:00 PM', y: 11.4, drilldown: 'temp12:00 PM' },
     { name: '1:00 PM', y: 12.9, drilldown: 'temp1:00 PM' },
     { name: '2:00 PM', y: 13.1, drilldown: 'temp2:00 PM' },
     { name: '3:00 PM', y: 13.2, drilldown: 'temp3:00 PM' },
     { name: '4:00 PM', y: 13.4, drilldown: 'temp4:00 PM' },
     { name: '5:00 PM', y: 12.6, drilldown: 'temp5:00 PM' },
     { name: '6:00 PM', y: 11.7, drilldown: 'temp6:00 PM' },
     { name: '7:00 PM', y: 10.9, drilldown: 'temp7:00 PM' },
     { name: '8:00 PM', y: 9.8, drilldown: 'temp8:00 PM' },
     { name: '9:00 PM', y: 8.8, drilldown: 'temp9:00 PM' },
     { name: '10:00 PM', y: 7.7, drilldown: 'temp10:00 PM' },
     { name: '11:00 PM', y: 7.4, drilldown: 'temp11:00 PM' },
     { name: '12:00 AM', y: 7, drilldown: 'temp12:00 AM' } ] },
{ id: 'windSpeed02',
  name: 'WindSpeed Mph',
  data: 
   [ { name: '1:00 AM', y: 6.7 },
     ...
     { name: '8:00 PM', y: 12.5 },
     { name: '9:00 PM', y: 13 },
     { name: '10:00 PM', y: 13.4 },
     { name: '11:00 PM', y: 13.9 },
     { name: '12:00 AM', y: 14.3 } ] },
{ id: 'humidity02',
  name: 'Humidity %',
  data: 
   [ { name: '1:00 AM', y: 0.95 },
     ...
     { name: '8:00 AM', y: 0.9 },
     { name: '9:00 AM', y: 0.88 },
     { name: '10:00 AM', y: 0.86 },
     { name: '11:00 AM', y: 0.82 },
     { name: '12:00 PM', y: 0.77 },
     { name: '1:00 PM', y: 0.73 },
     { name: '2:00 PM', y: 0.74 },
     { name: '3:00 PM', y: 0.74 },
     { name: '4:00 PM', y: 0.75 },
     ...
     { name: '8:00 PM', y: 0.86 },
     { name: '9:00 PM', y: 0.87 },
     { name: '10:00 PM', y: 0.88 },
     { name: '11:00 PM', y: 0.89 },
     { name: '12:00 AM', y: 0.9 } ] },
{ id: 'temperature03',
  name: 'Temperature deg.C',
  data: 
   [ { name: '1:00 AM', y: 6.7, drilldown: 'temp1:00 AM' },
     { name: '2:00 AM', y: 7, drilldown: 'temp2:00 AM' },
     { name: '3:00 AM', y: 7.3, drilldown: 'temp3:00 AM' },
     { name: '4:00 AM', y: 7.6, drilldown: 'temp4:00 AM' },
     { name: '5:00 AM', y: 7.8, drilldown: 'temp5:00 AM' },
     { name: '6:00 AM', y: 7.9, drilldown: 'temp6:00 AM' },
     { name: '7:00 AM', y: 8.1, drilldown: 'temp7:00 AM' },
     { name: '8:00 AM', y: 9, drilldown: 'temp8:00 AM' },
     { name: '9:00 AM', y: 9.9, drilldown: 'temp9:00 AM' },
     { name: '10:00 AM', y: 10.8, drilldown: 'temp10:00 AM' },
     { name: '11:00 AM', y: 11.1, drilldown: 'temp11:00 AM' },
     { name: '12:00 PM', y: 11.3, drilldown: 'temp12:00 PM' },
     { name: '1:00 PM', y: 11.6, drilldown: 'temp1:00 PM' },
     { name: '2:00 PM', y: 11.9, drilldown: 'temp2:00 PM' },
     { name: '3:00 PM', y: 12.2, drilldown: 'temp3:00 PM' },
     { name: '4:00 PM', y: 12.5, drilldown: 'temp4:00 PM' },
     { name: '5:00 PM', y: 12.3, drilldown: 'temp5:00 PM' },
     { name: '6:00 PM', y: 12.2, drilldown: 'temp6:00 PM' },
     { name: '7:00 PM', y: 12, drilldown: 'temp7:00 PM' },
     { name: '8:00 PM', y: 11.4, drilldown: 'temp8:00 PM' },
     { name: '9:00 PM', y: 10.8, drilldown: 'temp9:00 PM' },
     { name: '10:00 PM', y: 10.2, drilldown: 'temp10:00 PM' },
     { name: '11:00 PM', y: 9.3, drilldown: 'temp11:00 PM' },
     { name: '12:00 AM', y: 8.3, drilldown: 'temp12:00 AM' } ] },
{ id: 'windSpeed03',
  name: 'WindSpeed Mph',
  data: 
   [ { name: '1:00 AM', y: 14.8 },
     ...
     { name: '8:00 AM', y: 19 },
     { name: '9:00 AM', y: 19.2 },
     { name: '10:00 AM', y: 19.5 },
     { name: '11:00 AM', y: 19.5 },
     { name: '12:00 PM', y: 19.6 },
     { name: '1:00 PM', y: 19.7 },
     { name: '2:00 PM', y: 18.1 },
     { name: '3:00 PM', y: 16.6 },
     { name: '4:00 PM', y: 15 },
     ...
     { name: '9:00 PM', y: 9.5 },
     { name: '10:00 PM', y: 8.5 },
     { name: '11:00 PM', y: 10.2 },
     { name: '12:00 AM', y: 11.9 } ] },
{ id: 'humidity03',
  name: 'Humidity %',
  data: 
   [ { name: '1:00 AM', y: 0.91 },
     ...
     { name: '8:00 AM', y: 0.91 },
     { name: '9:00 AM', y: 0.92 },
     { name: '10:00 AM', y: 0.92 },
     { name: '11:00 AM', y: 0.92 },
     { name: '12:00 PM', y: 0.92 },
     { name: '1:00 PM', y: 0.92 },
     { name: '2:00 PM', y: 0.93 },
     { name: '3:00 PM', y: 0.93 },
     { name: '4:00 PM', y: 0.94 },
     ...
     { name: '10:00 PM', y: 0.97 },
     { name: '11:00 PM', y: 0.95 },
     { name: '12:00 AM', y: 0.93 } ] },
{ id: 'temperature04',
  name: 'Temperature deg.C',
  data: 
   [ { name: '1:00 AM', y: 6.2, drilldown: 'temp1:00 AM' },
     { name: '2:00 AM', y: 5.4, drilldown: 'temp2:00 AM' },
     { name: '3:00 AM', y: 4.5, drilldown: 'temp3:00 AM' },
     { name: '4:00 AM', y: 3.7, drilldown: 'temp4:00 AM' },
     { name: '5:00 AM', y: 4.1, drilldown: 'temp5:00 AM' },
     { name: '6:00 AM', y: 4.5, drilldown: 'temp6:00 AM' },
     { name: '7:00 AM', y: 4.9, drilldown: 'temp7:00 AM' },
     { name: '8:00 AM', y: 6.1, drilldown: 'temp8:00 AM' },
     { name: '9:00 AM', y: 7.4, drilldown: 'temp9:00 AM' },
     { name: '10:00 AM', y: 8.6, drilldown: 'temp10:00 AM' },
     { name: '11:00 AM', y: 9.4, drilldown: 'temp11:00 AM' },
     { name: '12:00 PM', y: 10.2, drilldown: 'temp12:00 PM' },
     { name: '1:00 PM', y: 11, drilldown: 'temp1:00 PM' },
     { name: '2:00 PM', y: 10.9, drilldown: 'temp2:00 PM' },
     { name: '3:00 PM', y: 10.9, drilldown: 'temp3:00 PM' },
     { name: '4:00 PM', y: 10.8, drilldown: 'temp4:00 PM' },
     { name: '5:00 PM', y: 10.4, drilldown: 'temp5:00 PM' },
     { name: '6:00 PM', y: 9.9, drilldown: 'temp6:00 PM' },
     { name: '7:00 PM', y: 9.5, drilldown: 'temp7:00 PM' },
     { name: '8:00 PM', y: 8.9, drilldown: 'temp8:00 PM' },
     { name: '9:00 PM', y: 8.4, drilldown: 'temp9:00 PM' },
     { name: '10:00 PM', y: 7.8, drilldown: 'temp10:00 PM' },
     { name: '11:00 PM', y: 7.5, drilldown: 'temp11:00 PM' },
     { name: '12:00 AM', y: 7.3, drilldown: 'temp12:00 AM' } ] },
{ id: 'windSpeed04',
  name: 'WindSpeed Mph',
  data: 
   [ { name: '1:00 AM', y: 11.4 },
...
{ id: 'humidity04',
  ...
  data: 
   [ { name: '1:00 AM', y: 0.91 },
     ...
     { name: '8:00 AM', y: 0.86 },
     { name: '9:00 AM', y: 0.83 },
     { name: '10:00 AM', y: 0.79 },
     { name: '11:00 AM', y: 0.77 },
     { name: '12:00 PM', y: 0.74 },
     { name: '1:00 PM', y: 0.71 },
     { name: '2:00 PM', y: 0.72 },
     { name: '3:00 PM', y: 0.73 },
     { name: '4:00 PM', y: 0.74 },
     ...
     { name: '8:00 PM', y: 0.8 },
     { name: '9:00 PM', y: 0.8 },
     { name: '10:00 PM', y: 0.79 },
     { name: '11:00 PM', y: 0.81 },
     { name: '12:00 AM', y: 0.82 } ] },
{ id: 'temp6:00 PM',
  name: 'Temperature deg.C',
  data: 
   [ { name: '6:00 M', y: 0.97 },
